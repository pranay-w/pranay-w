...
CSE undergraduate specializing in Artificial Intelligence and Machine Learning, with a focus on writing clean, structured code and building projects that solve real problems.

My work spans Python application development, frontend engineering with React, C programming fundamentals, and continuous DSA practice through graphs and advanced problem-solving patterns.
...
- Actively practicing trees, binary search trees, heaps, graphs, and graph traversal algorithms
- Developing advanced problem-solving patterns through structured DSA practice
- Writing clean, optimized solutions with a focus on interview preparation
...
- CLI Application Design — building terminal-based tools with input validation and structured program flow
- Problem Solving — decomposing complex problems into structured, testable logic
...
- Deepening React.js through component-driven project architecture
- Advancing Data Structures & Algorithms through graphs and complex problem-solving patterns
